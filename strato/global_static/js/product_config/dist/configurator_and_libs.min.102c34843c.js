...
var strato=strato||{};strato.namespace=function(a){var b,c=a.split("."),d=strato;for("strato"===c[0]&&(c=c.slice(1)),b=0;b<c.length;b++)"undefined"==typeof d[c[b]]&&(d[c[b]]={}),d=d[c[b]];return d},strato.namespace("strato.domainsearch"),strato.domainsearch.notepad={callbacks:[],addOnReadyFn:function(a){strato.domainsearch.notepad.callbacks.push(a)}},strato.domainsearch.progressbar={progress:0,getProgress:function(){return this.progress},checkIncomingProgress:function(a){return a>100&&(a=100),a},setProgress:function(a){a=this.checkIncomingProgress(a),this.progress=a,$("#Domainsuche_rahmen > div:first-child > div:first-child > div:nth-child(2) > div:first-child").css("width",a+"%")},increaseProgress:function(a){a=this.checkIncomingProgress(a);var b=this.progress+a;this.progress=b,$("#Domainsuche_rahmen > div:first-child > div:first-child > div:nth-child(2) > div:first-child").css("width",b+"%")}},strato.namespace("strato.productConfigurator"),strato.productConfigurator=angular.module("productConfigurator",["filters","schemaForm","smart-table"]),angular.module("filters",[]).filter("trustAsHtml",["$sce",function(a){return function(b){return a.trustAsHtml(b)}}]).filter("makeList",["$sce",function(a){return function(b){var c="";return $.each(b,function(a,b){var d=b.name.toLowerCase();d+=a!==b.length?",":"",c+="<li>"+d+"</li>"}),a.trustAsHtml(c)}}]).filter("replaceCommaWithPoint",function(){return function(a){var b="";return b=a.replace(".",",")}}),strato.productConfigurator.decoratorPath="/global_static/js/product_config/app/templates/decorators/bootstrap/",angular.module("schemaForm").config(["schemaFormDecoratorsProvider",function(a){a.addMapping("bootstrapDecorator","radios",strato.productConfigurator.decoratorPath+"myRadios.html"),a.addMapping("bootstrapDecorator","serverList",strato.productConfigurator.decoratorPath+"myServerList.html"),a.addMapping("bootstrapDecorator","myFieldset",strato.productConfigurator.decoratorPath+"myFieldset.html"),a.addMapping("bootstrapDecorator","dropdown",strato.productConfigurator.decoratorPath+"myDropdown.html"),a.addMapping("bootstrapDecorator","checkbox",strato.productConfigurator.decoratorPath+"myCheckbox.html"),a.addMapping("bootstrapDecorator","productinfo",strato.productConfigurator.decoratorPath+"myProductinfo.html"),a.addMapping("bootstrapDecorator","checkboxes",strato.productConfigurator.decoratorPath+"myCheckboxes.html"),a.addMapping("bootstrapDecorator","baseProduct",strato.productConfigurator.decoratorPath+"myBaseProduct.html"),a.addMapping("bootstrapDecorator","periodAndPrice",strato.productConfigurator.decoratorPath+"myBillingPeriodPrice.html"),a.addMapping("bootstrapDecorator","periodSwitch",strato.productConfigurator.decoratorPath+"myPeriodSwitch.html")}]),strato.productConfigurator.factory("ConditionsMetaMemService",function(){"use strict";var a={};return a.myData="",a.get=function(){return a.myData},a.set=function(b){a.myData=b},{get:function(){return a.get()},set:function(b){a.set(b)}}}),strato.productConfigurator.factory("ShoppingCartService",["AsfFormService",function(a){"use strict";var b={};return b.modelAsString="",b.model={},b.model.sum="",b.model.duration="",b.model.hardware="",b.CurrentCurrency="EUR",b.currencySign="",b.currencyDelimter="",b.INCLUSIVE="inklusive",b.EURO={sign:"€",delimter:","},b.CONTRACT_ID="vertrag",b.currencySign=b.EURO.sign,b.currencyDelimter=b.EURO.delimter,b.get=function(){return b.model},b.getDuration=function(){return b.model.duration},b.getCurrentShortnames=function(){var a,c=[];c.push(b.model.duration);for(a in b.model.items)c.push(b.model.items[a].shortname);return c},b.getPrintedPrice=function(a,c){var d="";return d=a+b.currencyDelimter+c+" "+b.currencySign},b.addPrice=function(a,c){var d="0",e="0";return"undefined"==typeof a.euro||"undefined"==typeof a.cent?void(c=""):(d=a.euro,e=a.cent,1===e.length&&(e+="0"),void(c=b.getPrintedPrice(d,e)))},b.addItemToModel=function(){b.model.items.push({})},b.addDescriptionToModelItem=function(a){b.model.items[b.model.items.length-1].name=a},b.addShortnameToModelItem=function(a){b.model.items[b.model.items.length-1].shortname=a},b.addPriceToModelItem=function(a,c){var d="0",e="0";return c===!0?void(b.model.items[b.model.items.length-1].price=b.INCLUSIVE):"undefined"==typeof a.euro||"undefined"==typeof a.cent?void(b.model.items[b.model.items.length-1].price=""):(null===a.euro&&(a.euro="0"),null===a.cent&&(a.cent="0"),"00"===a.euro&&(a.euro="0"),"00"===a.cent&&(a.cent="0"),d=a.euro,e=a.cent,1===e.length&&(e+="0"),void(b.model.items[b.model.items.length-1].price=b.getPrintedPrice(d,e)))},b.addOrderToModelItem=function(a){b.model.items[b.model.items.length-1].order=a},b.addFeaturesToModelItem=function(c){var d=0,e="",f="";if("undefined"!=typeof c){b.model.items[b.model.items.length-1].features=[];for(d in c)"duration"===c[d].name?(e=b.getDuration(),f=a.getCartLabelForItem(e)):f=c[d].value,b.model.items[b.model.items.length-1].features.push(f)}},b.setSum=function(a){var c="0",d="0";c=a.euro,d=a.cent,1===d.length&&(d+="0"),b.model.sum=b.getPrintedPrice(c,d)},b.setHardwarePrice=function(a){var c="0",d="0",e="";"undefined"!=typeof a&&"undefined"!=typeof a.euro&&"undefined"!=typeof a.cent&&(c=a.euro,d=a.cent,1===d.length&&(d+="0"),e=b.getPrintedPrice(c,d),b.model.items[0].price=e)},b.updateModel=function(c){var d={},e="",f="",g="",h=!1,i={},j=0,k="",l=!1,m=!1,n=!1;b.modelAsString=JSON.stringify(c),d=JSON.parse(b.modelAsString),b.model.items=[];for(e in d)d.hasOwnProperty(e)&&(f="",h=!1,d[e]===!0||d[e]===!1?d[e]===!0&&(f=e,h=!0):e!==b.CONTRACT_ID&&(f=d[e],h=!0),h===!0&&(i=a.getDataForShortnameFromLexicon(f),g=i.description,k=a.getParentCategory(f),l="undefined"!=typeof i.price,m="undefined"!=typeof i.isInclusive&&1===i.isInclusive,n="undefined"!=typeof i.notepadVisibility&&1===i.notepadVisibility||"server_hardware"===k,l===!0&&n===!0&&""!==f&&""!==g&&(b.addItemToModel(),b.addDescriptionToModelItem(g),b.addPriceToModelItem(i.price,m),b.addOrderToModelItem(j),b.addFeaturesToModelItem(i.features),b.addShortnameToModelItem(f),j++)))},b.setDuration=function(a){b.model.duration=a},b.setHardware=function(a){b.model.hardware=a},{getItems:function(){return b.get()},update:function(a){b.updateModel(a)},setHardwarePrice:function(a){b.setHardwarePrice(a)},setSum:function(a){b.setSum(a)},getCurrentShortnames:function(){return b.getCurrentShortnames()},setDuration:function(a){b.setDuration(a)},setHardware:function(a){b.setHardware(a)}}}]),strato.productConfigurator.factory("FileRequestService",function(){"use strict";var a={};return a.cache=[],a.getFileContent=function(b){var c,d;return"undefined"==typeof b||""===b?"":"undefined"!=typeof a.cache[b]?a.cache[b]:(c=$.ajax({url:b,async:!1}),d=c.responseText,a.cache[b]=d,d)},{getFileContent:function(b){return a.getFileContent(b)}}}),strato.productConfigurator.factory("DataService",["FileRequestService",function(a){"use strict";var b={};return b.cache=[],b.LEXICON_URL="/buy_static/strato/js/ger_configurator_lexicon_generated_from_db.js",b.LEXICON_META_DATA_URL="/buy_static/strato/js/ger_configurator_meta_data.js",b.CONSTRAINTS_URL="/buy/ger",b.INITIAL_CONSTRAINTS_URL="/buy/ger/server-konfigurator/initial",b.INITIALS_URL="/buy/ger/server-konfigurator/initial?",b.SPECS_URL="/buy/ger",b.CHOSEN_SPEC="chosenSpec",b.LINKED_CONF="linked_conf",b.getFileContent=function(b,c){var d,e;return d=a.getFileContent(b),"constraints"===c&&(d=d.replace("service_level_agreements","service_level_agreement")),e=""!==c?JSON.parse(d)[c]:JSON.parse(d)},b.getLexicon=function(a){return b.getFileContent(a,"lexicon")},b.getFirstPossiblePath=function(a){return b.getFileContent(a,"possible")[0][b.LINKED_CONF]},b.getConstraints=function(a){var c="";return c=b.getFirstPossiblePath(a),b.getFileContent(b.CONSTRAINTS_URL+c,"constraints")},b.getMetaData=function(a){return b.getFileContent(a,"metadata")},b.getInitials=function(a,c){var d="",e={};return d=a+c,e=b.getFileContent(d,"")},b.getChosenSpecs=function(a,c){var d="",e={};return d=a+c,e=b.getFileContent(d,""),"undefined"==typeof e[b.CHOSEN_SPEC]?[]:e[b.CHOSEN_SPEC]},{getMetaData:function(){return b.getMetaData(b.LEXICON_META_DATA_URL)},getConstraints:function(){return b.getConstraints(b.INITIAL_CONSTRAINTS_URL)},getLexicon:function(){return b.getLexicon(b.LEXICON_URL)},getInitials:function(a){return b.getInitials(b.INITIALS_URL,a)},getChosenSpecs:function(a){return b.getChosenSpecs(b.SPECS_URL,a)}}}]),strato.productConfigurator.factory("PrepareGetParametersService",["AsfFormService","DefaultsService",function(a,b){"use strict";var c={};return c.CART_INDEX="cartIndex",c.getKeyFromValueForArticles=function(b){return a.getParentCategory(b)},c.createGetParameter=function(a){var d="",e={},f="",g="";for(d in a)a.hasOwnProperty(d)&&(a[d]===!0||a[d]===!1?(f=c.getKeyFromValueForArticles(d),g=d,a[d]===!1&&(g=""),""!==f&&(e[f]=g)):e[d]=a[d]);return b.isDefaultsTriggeredAndHardwareHasBeenSet()===!0&&""!==b.getCartIndex()&&(e[c.CART_INDEX]=b.getCartIndex()),e},{getParamsToPost:function(a){return c.createGetParameter(a)}}}]),strato.productConfigurator.factory("PostFormService",["$window","PrepareGetParametersService",function(a,b){"use strict";var c={};return c.doSlashes=function(a){return"/"!==a.charAt(0)&&(a="/"+a),"/"!==a.slice(-1)&&(a+="/"),a},c.post=function(a,b,c){c=c||"get";var d,e,f=document.createElement("form");f.setAttribute("method",c),f.setAttribute("action",a);for(e in b)b.hasOwnProperty(e)&&(d=document.createElement("input"),d.setAttribute("type","hidden"),d.setAttribute("name",e),d.setAttribute("value",b[e]),f.appendChild(d));document.body.appendChild(f),f.submit()},c.sendModelData=function(d){var e,f;e=b.getParamsToPost(d),f=a.location.pathname,f=c.doSlashes(f),c.post(f+"complete/",e)},{sendModelData:function(a){c.sendModelData(a)}}}]),strato.productConfigurator.factory("ChangeHardwareEventService",["PriceService",function(a){"use strict";var b={};return b.hardwarePrice={},b.getPrice=function(b,c){return"undefined"==typeof b||"undefined"==typeof c?!1:a.getPrice(b,c)},b.getPriceAsync=function(b,c){return"undefined"==typeof b||"undefined"==typeof c?!1:a.getPriceAsync(b,c)},b.getNewPrice=function(a){function c(a,c){var d={};return c!==!1&&(d.newPrice=b.getPrice(a,c),b.hardwarePrice=d.newPrice),d}function d(){var a={},c=0,d=0,e=0,f=0,k=0,l="",m={};for(a=j.items[0],k=j.titleMap.length,c=0;k>c;c++)d=c,f=j.titleMap[d].value,f===h&&("more"===g&&(e=d+1),"less"===g&&(e=d-1),g===j.titleMap[c].value&&(e=c),e>k-1&&(e=0),0>e&&(e=k-1),l=j.titleMap[e].value,m.duration=l,c=k);return"false"!==i&&(m.newPrice=b.getPrice(i,l),b.hardwarePrice=m.newPrice),m}var e={},f=a.formKey,g=a.modelValue,h=a.pseudoContractDuration,i=a.pseudoHardware,j=a.formContractDuration,k="server_hardware",l="periodSwitch";if("undefined"==typeof f)return!1;switch(f[0]){case k:e=c(i,h);break;case l:e=d()}return e},b.getPriceForMultipleArticles=function(b){return a.getPriceForMultipleArticles(b)},{getNewPrice:function(a){return b.getNewPrice(a)},getPriceAsync:function(a,c){return b.getPriceAsync(a,c)},getPriceForMultipleArticles:function(a){return b.getPriceForMultipleArticles(a)},getHardwarePrice:function(){return b.hardwarePrice}}}]),strato.productConfigurator.factory("PriceService",function(){"use strict";var a={},b={},c=0,d={},e="/buy/ger/offer?",f="/buy/ger/allHardwareOffers",g="productId=",h=7200;return a.dateNow=function(){var a=0;return a=(new Date).getTime(),Math.floor(a/1e3)},a.deleteCache=function(){a.dateNow()>c+h&&(b=[],c=a.dateNow())},a.getPriceFromServerForMultipleArticles=function(c,d){var f={},h="",i="",j="";h=e;for(i in c)h+=g+c[i]+"&",j+=c[i];return h=h.slice(0,-1),a.deleteCache(),"undefined"==typeof b[j]?(f=$.ajax({url:h,async:d}),b[j]=f):f=b[j],f},a.getPriceFromServer=function(c,d,f){var h,i="";return"undefined"==typeof c||"undefined"==typeof d?!1:(a.deleteCache(),i=e+g+c+"&"+g+d,h=$.ajax({url:i,async:f}),b[c+"_"+d]=h,h)},a.getPriceAsJson=function(a){var b={},c={};return 500===a.status?(console&&console.log("error requesting price"),{}):(c=JSON.parse(a.responseText),c.error?(console&&console.log("no price info"),{}):(b.above="",b.below="",b.euro=0,b.cent=0,b.billingPeriod="",b.contractPeriod="",b.special="",null!==c.billingPeriod&&"undefined"!=typeof c.billingPeriod&&(b.above=c.billingPeriod,b.billingPeriod=c.billingPeriod),null!==c.contractPeriod&&"undefined"!=typeof c.contractPeriod&&(b.contractPeriod=c.contractPeriod),null!==c.monthlyPrice&&"undefined"!=typeof c.monthlyPrice&&(b.euro=c.monthlyPrice.toString().split(".")[0],b.cent=c.monthlyPrice.toString().split(".")[1]),null!==c.altMonthlyPrice&&"undefined"!=typeof c.altMonthlyPrice&&(b.below=c.altMonthlyPrice.toString()),null!==c.description&&"undefined"!=typeof c.description&&(b.special=c.description),b))},a.getPrice=function(c,d,e){var f={};return e=e||!1,a.deleteCache(),f="undefined"==typeof b[c+"_"+d]?a.getPriceFromServer(c,d,e):b[c+"_"+d],f!==!1&&(f=a.getPriceAsJson(f)),f},a.getPriceAsync=function(b,c,d){var e={};return e=a.getPrice(b,c,!0)},a.getPriceForMultipleArticles=function(b){var c="",d={};return c=a.getPriceFromServerForMultipleArticles(b,!1),d=a.getPriceAsJson(c),"undefined"==typeof d.cent&&(d={euro:"0",cent:"00"}),d},a.getAllHardwareOffers=function(){var a={};return a=$.ajax({url:f,async:!1}),a.status&&200!==a.status?{}:JSON.parse(a.responseText)},a.getOfferObject=function(a){var b={},c={};return b.status=200,b.responseText="",c.monthlyPrice=a.monthlyPrice,c.contractPeriod=a.contractPeriod,c.billingPeriod=a.billingPeriod,c.altMonthlyPrice=a.altMonthlyPrice,c.description=a.description,b.responseText=JSON.stringify(c),b},a.getDurationsFromOffers=function(a){var b=[],c={},d={};for(c in a)for(d in a[c])-1===b.indexOf(d)&&b.push(d);return b},a.writeAllHardwareOffersIntoCache=function(c){function d(a){return 0===Object.keys(a).length}var e=0,f={},g=[],h=0,i={};if(g=a.getDurationsFromOffers(c),h=g.length,d(c)!==!0)for(f in c)if(c.hasOwnProperty(f))for(e=0;h>e;e++)i=a.getOfferObject(c[f][g[e]]),b[f+"_"+g[e]]=i},c=a.dateNow(),d=a.getAllHardwareOffers(),a.writeAllHardwareOffersIntoCache(d),{getPrice:function(b,c){return a.getPrice(b,c)},getPriceAsync:function(b,c){return a.getPrice(b,c)},getPriceForMultipleArticles:function(b){return a.getPriceForMultipleArticles(b)}}}),strato.productConfigurator.factory("ClassificationService",[function(){"use strict";var a={};return a.classify_literal=function(a){var b=!0,c=a.split("&&");return a.match(/^\([a-zA-Z0-9_]+\)$/)?!0:(c.forEach(function(a){a.match(/^\([a-zA-Z0-9_]+\)$/)||(b=!1)}),b)},a.classify_aut=function(a){var b,c=!0,d=[],e=[],f=[];return a=a.replace(/^\(/,""),a=a.replace(/\)$/,""),d=a.split("||"),d.length<2?!1:a.match(/\&\&/)?(d.forEach(function(a){b=a.split("&&"),b.forEach(function(a){a.match(/^[^\!]/)&&-1===f.indexOf(a)&&f.push(a),a=a.replace(/^\!/,""),-1===e.indexOf(a)&&e.push(a)})}),e.length!==d.length?!1:(e.forEach(function(a){-1===f.indexOf(a)&&(c=!1)}),c)):!1},a.classify=function(b){var c="unknown";return"undefined"==typeof b?(console&&console.log("error: class: prepare_schema_form.js method: classify msg: term is undefined"),c):(b.match(/^\(([a-zA-Z0-9_]+\|\|)+[a-zA-Z0-9_]+\)$/)?c="disjunctive_term":a.classify_aut(b)?c="aut":b.match(/^\(\!\(([a-zA-Z0-9_]+\|\|)+[a-zA-Z0-9_]+\)\|\|[a-zA-Z0-9_]+\)$/)?c="conditional":a.classify_literal(b)?c="literal":b.match(/^\(\#[a-zA-Z0-9_\*]+\)$/)?c="hashmark_literal":b.match(/^\(\![a-zA-Z0-9_]+\)$/)&&(c="negated_literal"),c)},a.getSchemaType=function(a){switch(a){case"aut":return"string";case"hashmark_literal":return"boolean";case"literal":return"boolean";default:return""}},a.getFormType=function(a){switch(a){case"aut":return"radios";case"hashmark_literal":return"checkbox";case"literal":return"checkbox";default:return""}},{classify:function(b){return a.classify(b)},getSchemaType:function(b){return a.getSchemaType(b)},getFormType:function(b){return a.getFormType(b)}}}]),strato.productConfigurator.factory("AsfFormService",["DataManipulationService","DataService","ClassificationService",function(a,b,c){"use strict";var d={};return d.CHANGE_EVENTS={},d.CHANGE_EVENTS.MODEL_CHANGED="modelChanged()",d.CHANGE_EVENTS.VALUE_CHANGED="valueChanged()",d.lexicon={},d.constraints={},d.metaData={},d.form=[],d.addCategoriesToForm=function(a){var b={},c=[],e=0;c=a.categories;for(b in c)"undefined"==typeof c[b].subClassOf&&(d.form.push({}),e=d.form.length-1,d.form[e].id=c[b].id,d.form[e].title=c[b].label,d.form[e].type="myFieldset",d.form[e].items=[])},d.getConstraint=function(a){var b="";for(b in d.constraints)if(d.constraints[b].configuration_variable===a)return d.constraints[b].constraint;return""},d.determineTypeFromItem=function(a){var b="",e="",f="",g={};return b=d.getConstraint(a),e=c.classify(b),f=c.getFormType(e),g={},g.formType=f,g.classification=e,g},d.hasMoreThanOneValue=function(a){var b="";for(b in d.lexicon.configuration_variables)if(d.lexicon.configuration_variables[b].id===a&&d.lexicon.configuration_variables[b].hasValue.length>1)return!0;return!1},d.getKeyForItem=function(a){var b="";for(b in d.lexicon.configuration_variables)if(d.lexicon.configuration_variables[b].id===a&&1===d.lexicon.configuration_variables[b].hasValue.length)return d.lexicon.configuration_variables[b].hasValue[0];return""},d.getLabelForItem=function(a){var b=0;for(b in d.metaData.itemLabels)if(d.metaData.itemLabels[b].id===a)return d.metaData.itemLabels[b].label;return""},d.getCartLabelForItem=function(a){var b=0;for(b in d.metaData.itemLabels)if(d.metaData.itemLabels[b].id===a)return d.metaData.itemLabels[b].cartLabel;return""},d.getCpuForItem=function(a){function b(a){return a=a.replace("2x","2 x ")}var c=0,e="";for(c in d.lexicon.specifications)if(d.lexicon.specifications[c].id===a&&(e=d.lexicon.specifications[c].features[0],"undefined"!=typeof e))return e=b(e.value);return""},d.getCpuSpeedForItem=function(a){function b(a){return a=a.replace("pro ","/")}var c=0,e="";for(c in d.metaData.product_cpuspeed)if(d.metaData.product_cpuspeed[c].id===a)return e=d.metaData.product_cpuspeed[c].cpuspeed,e=b(e);return""},d.getHddForItem=function(a){function b(a){return a=a.replace("Festplatte",""),a=a.replace("2 x 500 GB","2 x  500 GB"),a=a.replace(" + ","<br>")}var c=0,e="";for(c in d.lexicon.specifications)if(d.lexicon.specifications[c].id===a&&(e=d.lexicon.specifications[c].features[2],"undefined"!=typeof e))return e=b(e.value);return""},d.getRamForItem=function(a){function b(a){return a=a.replace("RAM",""),a=a.replace(" GB",""),a=a.replace(" ","")}var c=0,e="";for(c in d.lexicon.specifications)if(d.lexicon.specifications[c].id===a&&(e=d.lexicon.specifications[c].features[1],"undefined"!=typeof e))return e=b(e.value);return""},d.getMinPriceForItem=function(a){function b(a){return null!==a&&(a=a.replace(",","."),a=a.replace(" ","")),a}var c=0,e="";for(c in d.lexicon.specifications)if(d.lexicon.specifications[c].id===a&&(e=d.lexicon.specifications[c].minPrice,"undefined"!=typeof e))return e=b(e);return""},d.getProductInfo=function(a){var b=0,c={};for(b in d.metaData.productinfos)d.metaData.productinfos[b].product_name===a&&(c=JSON.parse(JSON.stringify(d.metaData.productinfos[b].productinfos[0])));return c.type="productinfo",c.product_name=a,c.shortname="default",c},d.getProductInfoForHardware=function(a,b){var c=0,e={},f={},g="",h="",i=0;h="<table><tr><td>CPU:</td><td>#cpu#</td></tr><tr><td>CPU-Leistung:</td><td>#cpuspeed#</td></tr><tr><td>Festplatte:</td><td>#hdd#</td></tr><tr><td>Arbeitsspeicher:</td><td>#ram#</td></tr></table>";for(c in d.lexicon.specifications)if(d.lexicon.specifications[c].id===b){f.euro=d.lexicon.specifications[c].minPriceIntegerPlace,f.cent=d.lexicon.specifications[c].minPriceDecimalPlace,g=h,g=g.replace("#cpu#",d.lexicon.specifications[c].features[0].value),g=g.replace("#ram#",d.lexicon.specifications[c].features[1].value),g=g.replace("#hdd#",d.lexicon.specifications[c].features[2].value);for(i in d.metaData.product_cpuspeed)d.metaData.product_cpuspeed[i].id===b&&(g=g.replace("#cpuspeed#",d.metaData.product_cpuspeed[i].cpuspeed))}return e.price=f,e.text=g,e.type="productinfo",e.product_name=a,e.shortname=b,e},d.getProductInfos=function(a){var b=[],c={},e=0,f=0,g=0;if("server_hardware"===a){for(e in d.lexicon.configuration_variables)if(d.lexicon.configuration_variables[e].id===a)for(f=d.lexicon.configuration_variables[e].hasValue.length,g=0;f>g;g++)c=d.getProductInfoForHardware(a,d.lexicon.configuration_variables[e].hasValue[g]),b.push(c);c={},c.text="<table><tr><td>CPU:</td><td>-----</td></tr><tr><td>CPU-Leistung:</td><td>-----</td></tr><tr><td>Festplatte:</td><td>-----</td></tr><tr><td>Arbeitsspeicher:</td><td>-----</td></tr></table>",c.type="productinfo",c.product_name="server_hardware",c.shortname="noname",b.push(c)}else c=d.getProductInfo(a),b.push(c);return b},d.getSubClassOf=function(a){var b=0;for(b in d.lexicon.specifications)if(d.lexicon.specifications[b].id===a)return d.lexicon.specifications[b].subClassOf;return""},d.getTitleMaps=function(a){var b=0,c=[],e=0,f=0,g={},h=[],i="",j={},k=0;for(b in d.lexicon.configuration_variables)d.lexicon.configuration_variables[b].id===a&&(c=JSON.parse(JSON.stringify(d.lexicon.configuration_variables[b].hasValue)));for(e=c.length,j=d.metaData.group_information,f=0;e>f;f++){if(g={},"server_hardware"===a)for(i=d.getSubClassOf(c[f]),k=0;k<j.length;k++)i===j[k].id&&(g.group=j[k].label);g.value=c[f],g.name=d.getLabelForItem(c[f]),g.cpu=d.getCpuForItem(c[f]),g.cpuspeed=d.getCpuSpeedForItem(c[f]),g.hdd=d.getHddForItem(c[f]),g.ram=parseInt(d.getRamForItem(c[f])),g.price=parseFloat(d.getMinPriceForItem(c[f])),h.push(g)}return h},d.hasCategoryAnySubCategories=function(a){var b=0;for(b in d.lexicon.categories)if("undefined"!=typeof d.lexicon.categories[b].subClassOf&&d.lexicon.categories[b].subClassOf===a)return!0;return!1},d.getProductLabel=function(a){var b=0;for(b in d.metaData.productLabels)if(d.metaData.productLabels[b].id===a)return d.metaData.productLabels[b].label;return""},d.addItemToCategory=function(a,b){var c={},e=[],f="",g=0,h="",i="",j="",k=!1,l=!1,m=!0,n=!1,o={};e=a.categories,h=b.id;for(c in e)k="undefined"!=typeof e[c].subClassOf,l=e[c].subClassOf===h,m=d.hasCategoryAnySubCategories(h),n=e[c].id===h,j="",m===!1&&n===!0&&(j=d.getProductLabel(h)),(k&&l||m===!1&&n===!0)&&(b.items.push({}),g=b.items.length-1,f=e[c].id,o=d.determineTypeFromItem(f),b.items[g].type=o.formType,"literal"===o.classification&&(b.items[g].readonly=!0),""===j&&(j=e[c].label),b.items[g].title=j,b.items[g].product_name=f,b.items[g].onChange=d.CHANGE_EVENTS.MODEL_CHANGED,"vertrag"!==f&&(b.items[g].productinfos=d.getProductInfos(f)),d.hasMoreThanOneValue(f)===!0?(b.items[g].titleMap=d.getTitleMaps(f),b.items[g].key=f):(i=d.getKeyForItem(f),b.items[g].key=i,b.items[g].label=d.getLabelForItem(i)))},d.addItemsToCategories=function(a){var b=0;for(b in d.form)d.addItemToCategory(a,d.form[b])},d.init=function(){var c=!1;d.lexicon=b.getLexicon(),d.constraints=b.getConstraints(),d.metaData=b.getMetaData(),d.addCategoriesToForm(d.lexicon),d.addItemsToCategories(d.lexicon),c=a.checkAsfForm(d.form),c===!0?d.form=a.manipulateAsfForm(d.form):console&&console.log(": class: asf_form.js method: init: requirements for data manipulation not fulfilled")},d.getParentCategory=function(a){var b=0,c=0,e=[];for(b in d.lexicon.configuration_variables)for(e=d.lexicon.configuration_variables[b].hasValue,c=0;c<e.length;c++)if(e[c]===a)return d.lexicon.configuration_variables[b].id;return""},d.getJsonForm=function(){return d.form},d.getDataForShortnameFromLexicon=function(a){var b={},c={},e={},f={};c={},c.id=a;for(b in d.metaData.itemLabels)d.metaData.itemLabels[b].id===a&&(c.description=d.metaData.itemLabels[b].cartLabel);e={},e.name=null,e.value="",f={},f.name="duration",f.value="";for(b in d.metaData.product_cpuspeed)d.metaData.product_cpuspeed[b].id===a&&(e.value=d.metaData.product_cpuspeed[b].cpuspeed);for(b in d.lexicon.specifications)if(d.lexicon.specifications[b].id===a)return c.price={},c.price.euro=d.lexicon.specifications[b].monthlyPriceIntegerPlace,c.price.cent=d.lexicon.specifications[b].monthlyPriceDecimalPlace,"00"==c.price.euro&&(c.price.euro="0"),"00"==c.price.cent&&(c.price.cent="0"),"undefined"!=typeof d.lexicon.specifications[b].features&&(c.features=JSON.parse(JSON.stringify(d.lexicon.specifications[b].features)),"server_hardware"===d.getParentCategory(a)&&(c.features[0]=f,c.features.push(e))),"undefined"!=typeof d.lexicon.specifications[b].isInclusive&&(c.isInclusive=d.lexicon.specifications[b].isInclusive),"undefined"!=typeof d.lexicon.specifications[b].notepadVisibility&&(c.notepadVisibility=d.lexicon.specifications[b].notepadVisibility),c;return""},d.init(),{getJsonForm:function(){return d.getJsonForm()},getParentCategory:function(a){return d.getParentCategory(a)},getDataForShortnameFromLexicon:function(a){return d.getDataForShortnameFromLexicon(a)},getCartLabelForItem:function(a){return d.getCartLabelForItem(a)}}}]),strato.productConfigurator.factory("AsfSchemaService",["DataManipulationService","DataService","ClassificationService","DefaultsService",function(a,b,c,d){"use strict";var e={};return e.CHANGE_EVENTS={},e.CHANGE_EVENTS.MODEL_CHANGED="modelChanged()",e.CHANGE_EVENTS.VALUE_CHANGED="valueChanged()",e.lexicon={},e.constraints={},e.metaData={},e.schema={},e.getConstraint=function(a){var b="";for(b in e.constraints)if(e.constraints[b].configuration_variable===a)return e.constraints[b].constraint;return""},e.getMainObject=function(){return{type:"object",properties:{}}},e.hasMoreThanOneValue=function(a){var b="";for(b in e.lexicon.configuration_variables)if(e.lexicon.configuration_variables[b].id===a&&e.lexicon.configuration_variables[b].hasValue.length>1)return!0;return!1},e.getValue=function(a){var b="";for(b in e.lexicon.configuration_variables)if(e.lexicon.configuration_variables[b].id===a&&1===e.lexicon.configuration_variables[b].hasValue.length)return e.lexicon.configuration_variables[b].hasValue[0];return""},e.getValues=function(a){var b="";for(b in e.lexicon.configuration_variables)if(e.lexicon.configuration_variables[b].id===a&&e.lexicon.configuration_variables[b].hasValue.length>1)return e.lexicon.configuration_variables[b].hasValue;return""},e.hasCategoryAnySubCategories=function(a){var b=0;for(b in e.lexicon.categories)if("undefined"!=typeof e.lexicon.categories[b].subClassOf&&e.lexicon.categories[b].subClassOf===a)return!0;return!1},e.addCategories=function(a){var b=0,c="",d=!1,f=!1,g=!1;for(b in e.lexicon.categories)c=e.lexicon.categories[b].id,d=e.hasCategoryAnySubCategories(c),f="undefined"!=typeof e.lexicon.categories[b].subClassOf,g="server_hardware"===e.lexicon.categories[b].subClassOf,(f&&!g||!d&&!g)&&(e.hasMoreThanOneValue(c)===!1&&(c=e.getValue(c)),a.properties[c]={});return a},e.setDefaults=function(a){var b=0,c=0;for(b in a.properties)for(c in e.metaData.product_defaults)e.metaData.product_defaults[c].id===b&&(a.properties[b]["default"]=e.metaData.product_defaults[c]["default"]);return a},e.getParentCategory=function(a){var b=0,c=0,d=[];for(b in e.lexicon.configuration_variables)for(d=e.lexicon.configuration_variables[b].hasValue,c=0;c<d.length;c++)if(d[c]===a)return e.lexicon.configuration_variables[b].id;return""},e.setDefaultsFromChosenSpecs=function(a,b){var c=0,f=0,g=0,h="";g=b.length;for(c in a.properties)if("boolean"===a.properties[c].type)for(f=0;g>f;f++)b[f]===c&&(a.properties[c]["default"]=!0);else if("string"===a.properties[c].type)for(f=0;g>f;f++)h=e.getParentCategory(b[f]),h===c&&(a.properties[c]["default"]=b[f],"server_hardware"===h&&d.setServerHardware(b[f]));return a},e.setEnumForServerHardware=function(a){var b=0,c="server_hardware";for(b in a.properties)b===c&&(a.properties[b]["enum"]=e.getValues(c));return a},e.getCategoryFromLexicon=function(a){var b=0,c=0,d=[];for(b in e.lexicon.configuration_variables)for(d=e.lexicon.configuration_variables[b].hasValue,c=0;c<d.length;c++)if(d[c]===a)return e.lexicon.configuration_variables[b].id;return""},e.setType=function(a){var b=0,d="",f="",g="",h="";for(b in a.properties)d=e.getConstraint(b),""===d&&(h=e.getCategoryFromLexicon(b),d=e.getConstraint(h)),f=c.classify(d),g=c.getSchemaType(f),a.properties[b].type=g;return a},e.init=function(){var c=!1,f={};e.lexicon=b.getLexicon(),e.constraints=b.getConstraints(),e.metaData=b.getMetaData(),e.schema=e.getMainObject(),e.schema=e.addCategories(e.schema),e.schema=e.setDefaults(e.schema),e.schema=e.setType(e.schema),e.schema=e.setEnumForServerHardware(e.schema),c=a.checkAsfSchema(e.schema),c===!0?e.schema=a.manipulateAsfSchema(e.schema):console&&console.log(": class: asf_schema.js method: init: requirements for data manipulation not fulfilled"),d.isDefaultsTriggered()===!0&&(f=d.getDefaults(),e.schema=e.setDefaultsFromChosenSpecs(e.schema,f))},e.getJsonSchema=function(){return e.schema},e.init(),{getJsonSchema:function(){return e.getJsonSchema()}}}]),strato.productConfigurator.factory("ProductConfigService",["AsfFormService","AsfSchemaService",function(a,b){"use strict";var c={};return c.getJsonForm=function(){return a.getJsonForm()},c.getJsonSchema=function(){return b.getJsonSchema()},c.getDurations=function(){var a=[];return a=["CONTRACT_1_MONTH","CONTRACT_12_MONTHS","CONTRACT_24_MONTHS"]},c.getHardwareProductShortnames=function(){var a=[];return a=["SOL_K38"]},{getJsonForm:function(){return c.getJsonForm()},getJsonSchema:function(){return c.getJsonSchema()},getDurations:function(){return c.getDurations()},getHardwareProductShortnames:function(){return c.getHardwareProductShortnames()}}}]),strato.productConfigurator.factory("DataManipulationCheckService",function(){"use strict";var a={},b="product_name",c="server_hardware",d="properties";return a.getAllObjectsWithFieldset=function(a){var b,c={},d=0,e=0;for(d=a.length,e=0;d>e;e++)b=a[e],"myFieldset"===b.type&&(c[e]=b);return c},a.hasProductName=function(a,c){var d={},e=0;for(d in a)if(a[d])for(e=0;e<a[d].items.length;e++)if(a[d].items[e]&&a[d].items[e][b]===c)return!0;return!1},a.checkAsfForm=function(b){var d={},e=!1,f=!1;return d=a.getAllObjectsWithFieldset(b),e=a.hasProductName(d,"vertrag"),f=a.hasProductName(d,c),e===!0&&f===!0?!0:!1},a.checkAsfSchema=function(a){return a&&a[d]&&a[d][c]&&a[d].vertrag?!0:!1},a.check=function(b,c){return a.checkForm(b)&&a.checkSchema(c)?!0:!1},{check:function(b,c){return a.check(b,c)},checkAsfForm:function(b){return a.checkAsfForm(b)},checkAsfSchema:function(b){return a.checkAsfSchema(b)}}}),strato.productConfigurator.factory("DataManipulationFormService",function(){"use strict";var a={},b="product_name",c="server_hardware",d="baseProduct",e="serverList",f="myFieldset",g="items",h="onChange",i="valueChanged(form.key,modelValue)",j="modelChanged()";return a.rewriteBaseProduct=function(a){var e=0,g=0,h=0;for(e=a.length,g=0;e>g;g++)if(a[g].type===f)for(h=0;h<a[g].items.length;h++)a[g].items[h]&&a[g].items[h][b]===c&&(a[g].type=d);return a},a.changeTypeForHardware=function(a){var f=0,g=0,h=0;for(f=a.length,g=0;f>g;g++)if(a[g].type===d)for(h=0;h<a[g].items.length;h++)a[g].items[h]&&a[g].items[h][b]===c&&(a[g].items[h].type=e);return a},a.addOnChange=function(a){var e=0,g=0,k=0;for(e=a.length,g=0;e>g;g++)if(a[g].type===d)for(k=0;k<a[g].items.length;k++)a[g].items[k]&&a[g].items[k][b]===c?a[g].items[k][h]=i:a[g].items[k][h]=j;else if(a[g].type===f)for(k=0;k<a[g].items.length;k++)a[g].items[k]&&(a[g].items[k][h]=j);return a},a.getContractObjectAsf=function(a){var c=0,d={},e=0,g=0;for(c=a.length,e=0;c>e;e++)if(a[e].type===f)for(g=0;g<a[e].items.length;g++)if(a[e].items[g]&&"vertrag"===a[e].items[g][b])return d=JSON.parse(JSON.stringify(a[e].items[g]));return d},a.removeContractObjectAsf=function(a){var c=0,d=0,e=0;for(c=a.length,d=0;c>d;d++)if(a[d].type===f)for(e=0;e<a[d].items.length;e++)if(a[d].items[e]&&"vertrag"===a[d].items[e][b])return a.splice(d,1),a;return a},a.changeTypeOfContractObject=function(a){return a.type="periodAndPrice",a},a.addOnChangeToContractObject=function(a){return a[h]=i,a},a.getMoreLessItem=function(){var a={},b="";return a.items=[],b='{"type": "periodSwitch","key": "periodSwitch","onChange" : "valueChanged(form.key,modelValue)","titleMap": [{"value": "less","name": "<<"}, {"value": "more","name": ">>"}]}',
a.items.push(JSON.parse(b)),a},a.addLessMoreObjectToContract=function(a,b){return a.items=b.items,a},a.addContractObjectToForm=function(a,e){var f=0,h=0,i=0;for(f=a.length,h=0;f>h;h++)if(a[h].type===d)for(i=0;i<a[h].items.length;i++)if(a[h].items[i]&&a[h].items[i][b]===c)return a[h].items[i][g]=[],a[h].items[i][g].push(e),a;return a},a.addContractItemsAsf=function(b){var c={},d={};return c=a.getContractObjectAsf(b),b=a.removeContractObjectAsf(b),c=a.changeTypeOfContractObject(c),c=a.addOnChangeToContractObject(c),d=a.getMoreLessItem(),c=a.addLessMoreObjectToContract(c,d),b=a.addContractObjectToForm(b,c)},a.manipulateAsf=function(b){return b=a.rewriteBaseProduct(b),b=a.changeTypeForHardware(b),b=a.addOnChange(b),b=a.addContractItemsAsf(b)},{manipulateAsf:function(b){return a.manipulateAsf(b)}}}),strato.productConfigurator.factory("DataManipulationSchemaService",function(){"use strict";var a={};return a.CONTRACT_ID="vertrag",a.addEnumToContractAsf=function(a){var b="";return b='["CONTRACT_1_MONTH","CONTRACT_12_MONTHS","CONTRACT_24_MONTHS"]',a.properties.vertrag["enum"]=JSON.parse(b),a},a.getPeriodSwitch=function(){var a={},b="";return b='{"type": "string","default": false,"required": false,"enum": ["less","more"]}',a.periodSwitch=JSON.parse(b),a},a.addPeriodSwitchToSchema=function(a,b){return a.properties.periodSwitch=b.periodSwitch,a},a.manipulateAsf=function(b){var c={};return b=a.addEnumToContractAsf(b),c=a.getPeriodSwitch(),b=a.addPeriodSwitchToSchema(b,c)},{manipulateAsf:function(b){return a.manipulateAsf(b)}}}),strato.productConfigurator.factory("DataManipulationService",["DataManipulationCheckService","DataManipulationFormService","DataManipulationSchemaService",function(a,b,c){"use strict";var d={};return d.check=function(b,c){return a.check(b,c)},d.checkAsfForm=function(b){return a.checkAsfForm(b)},d.checkAsfSchema=function(b){return a.checkAsfSchema(b)},d.manipulateAsfForm=function(a){return b.manipulateAsf(a),a},d.manipulateAsfSchema=function(a){return c.manipulateAsf(a),a},{check:function(a,b){return d.check(a,b)},checkAsfForm:function(a){return d.checkAsfForm(a)},checkAsfSchema:function(a){return d.checkAsfSchema(a)},manipulateAsfForm:function(a){return d.manipulateAsfForm(a)},manipulateAsfSchema:function(a){return d.manipulateAsfSchema(a)}}}]),strato.productConfigurator.factory("DefaultsService",["DataService","$window",function(a,b){"use strict";var c={};return c.serverHardware="",c.cartIndex="",c.triggerParam="",c.CART_INDEX="cartIndex",c.CONFIGURATION="configuration",c.CHOSEN_SPEC="chosenSpec",c.POSSIBLE="possible",c.SPEC_TO_BE_ADDED="spec_to_be_added",c.LINKED_CONF="linked_conf",c.parseQueryString=function(a){var b={};return a.replace(new RegExp("([^?=&]+)(=([^&]*))?","g"),function(a,c,d,e){b[c]=e}),b},c.isDefaultsTriggered=function(){var a="",d={};return a=b.location.search,""===a?!1:(d=c.parseQueryString(a),"undefined"!=typeof d[c.CART_INDEX]&&""!==d[c.CART_INDEX]?(c.triggerParam=c.CART_INDEX,!0):"undefined"!=typeof d[c.CONFIGURATION]||""!==d[c.CONFIGURATION]?(c.triggerParam=c.CONFIGURATION,!0):!1)},c.getChosenSpec=function(a){return"undefined"==typeof a[c.CHOSEN_SPEC]?"":a[c.CHOSEN_SPEC][0]},c.getPathForChosenSpec=function(a,b){var d=0,e=0;if("undefined"==typeof a[c.POSSIBLE]||a[c.POSSIBLE].length<1)return"";for(e=a[c.POSSIBLE].length,d=0;e>d;d++)if(a[c.POSSIBLE][d][c.SPEC_TO_BE_ADDED][0]===b)return a[c.POSSIBLE][d][c.LINKED_CONF];return""},c.setCartIndex=function(a){c.cartIndex=a},c.getCartIndex=function(){return c.cartIndex},c.getPath=function(){var d="",e={},f="",g="";return d=c.parseQueryString(b.location.search)[c.triggerParam],e=a.getInitials(c.triggerParam+"="+d),f=c.getChosenSpec(e),g=c.getPathForChosenSpec(e,f),c.triggerParam===c.CART_INDEX&&c.setCartIndex(d),g},c.getConstraints=function(a){return{}},c.getServerHardware=function(){return c.serverHardware},c.getDefaults=function(){var b="",d={};return b=c.getPath(),""===b?{}:d=a.getChosenSpecs(b)},c.setServerHardware=function(a){c.serverHardware=a},c.isDefaultsTriggeredAndHardwareHasBeenSet=function(){return c.isDefaultsTriggered()===!0&&""!==c.getServerHardware()?!0:!1},{isDefaultsTriggered:function(){return c.isDefaultsTriggered()},getDefaults:function(){return c.getDefaults()},getServerHardware:function(){return c.getServerHardware()},setServerHardware:function(a){return c.setServerHardware(a)},getCartIndex:function(){return c.getCartIndex()},isDefaultsTriggeredAndHardwareHasBeenSet:function(){return c.isDefaultsTriggeredAndHardwareHasBeenSet()}}}]),strato.productConfigurator.controller("FormController",["$scope","$rootScope","$window","$timeout","ProductConfigService","PostFormService","ChangeHardwareEventService","ShoppingCartService","DefaultsService",function(a,b,c,d,e,f,g,h,i){"use strict";function j(){a.formData=e.getJsonForm(),a.schemaData=e.getJsonSchema(),d(function(){i.isDefaultsTriggeredAndHardwareHasBeenSet()===!0&&(a.valueChanged(["server_hardware"],i.getServerHardware()),a.$apply())},400)}var k="",l="CONTRACT_24_MONTHS";a.model={},a.schemaData={},a.formData=[],a.hardwareSelected=!1,a.modelChanged=function(){var d={},e={},f=[],i="",j="server_hardware";d.hardwareSelected=!1,a.hardwareSelected=!1,"undefined"!=typeof a.model[j]&&(d.hardwareSelected=!0,a.hardwareSelected=!0),h.update(a.model),e=g.getHardwarePrice(),h.setHardwarePrice(e),f=h.getCurrentShortnames(),i=g.getPriceForMultipleArticles(f),h.setSum(i),b.$broadcast("config.model:changed",d),c.scrollBy(0,1),c.scrollBy(0,-1)},a.valueChanged=function(b,c){var d={},e={},f="server_hardware",j="vertrag",m="periodSwitch";return"undefined"==typeof b?!1:(k!==a.model[f]&&i.isDefaultsTriggered()===!1&&(a.model[j]=l),k=a.model[f],e.formKey=b,e.modelValue=c,e.pseudoContractDuration=a.model[j]||!1,e.pseudoHardware=a.model[f],e.formContractDuration=a.formData[0].items[0].items[0],d=g.getNewPrice(e),"undefined"!=typeof d.duration&&(a.model[j]=d.duration),h.setHardware(a.model[f]),h.setDuration(a.model[j]),a.formData[0].items[0].items[0].price=d.newPrice,a.modelChanged(),a.model[m]=!1,!0)},a.pretty=function(){return JSON.stringify(a.model,void 0,4,4)},a.onSubmit=function(){a.stratoConfigForm.$valid?f.sendModelData(a.model):console&&console.log("error: productconfig_form.onSubmit - form data are invalid")},j(),a.$on("notepad:sendCart",function(b,c){a.onSubmit()})}]),strato.productConfigurator.controller("NotepadController",["$scope","$rootScope","ShoppingCartService",function(a,b,c){"use strict";var d={};a.showMe=!1,d.data={},a.sendCart=function(){b.$broadcast("notepad:sendCart")},a.$on("config.model:changed",function(b,e){"undefined"!=typeof e&&"undefined"!=typeof e.hardwareSelected&&(a.showMe=e.hardwareSelected),d.data=c.getItems(),a.data=d.data})}]),strato.productConfigurator.controller("FootnotesController",["$scope",function(a){"use strict";a.showMe=!1,a.$on("config.model:changed",function(b,c){"undefined"!=typeof c&&"undefined"!=typeof c.hardwareSelected&&(a.showMe=c.hardwareSelected)})}]),$(window).scroll(function(){var a=0,b={},c=0,d={},e=0,f={},g=!1,h=!1,i=!1,j=0,k=!1,l=25,m=20,n=20;$(".server_hardware")&&null!==$(".server_hardware").offset()&&(b=$("#st_product_conf_notepad"),d=$(".server_hardware"),f=$(".product_info"),g=b.hasClass("fixed_note"),i=b.hasClass("pushed_note"),a=$(window).scrollTop(),c=b.offset().top-a,k=b.offset().top!==a,e=d.offset().top-a,h=n+m+a+l+b.height()>f.offset().top,j=f.offset().top-(b.height()+m+l+n),g?(e>=l&&(b.removeClass("fixed_note pushed_note"),b.addClass("normal_note"),b.css("top","")),h&&(b.removeClass("fixed_note normal_note"),b.addClass("pushed_note"),b.css("top",j))):!i&&k&&l>c||i&&!h?(b.removeClass("pushed_note normal_note"),b.addClass("fixed_note"),b.css("top","0px")):i&&b.css("top",j))}),strato.productConfigurator.scollBy=function(a){var b=0;null!==$("#serverProductInfo").offset()&&(b=$("#serverProductInfo").offset().top-$(window).height()+455,b>$(window).scrollTop()&&$("html, body").animate({scrollTop:b},300))},strato.productConfigurator.selectRow=function(a){var b=0,c=0;for(b=0;b<a.childNodes.length;b++)if("TD"===a.childNodes[b].tagName)for(c=0;c<a.childNodes[b].childNodes.length;c++)"INPUT"===a.childNodes[b].childNodes[c].tagName&&(a.childNodes[b].childNodes[c].click(),strato.productConfigurator.scollBy())},strato.productConfigurator.parseQueryString=function(a){var b={};return a.replace(new RegExp("([^?=&]+)(=([^&]*))?","g"),function(a,c,d,e){b[c]=e}),b},strato.productConfigurator.isDefaultsTriggered=function(){var a="",b={};return a=window.location.search,""===a?!1:(b=strato.productConfigurator.parseQueryString(a),"undefined"!=typeof b.cartIndex&&""!==b.cartIndex?!0:"undefined"!=typeof b.configuration||""!==b.configuration?!0:!1)},strato.productConfigurator.isDefaultsTriggered()===!0&&window.setTimeout(strato.productConfigurator.scollBy,1500);