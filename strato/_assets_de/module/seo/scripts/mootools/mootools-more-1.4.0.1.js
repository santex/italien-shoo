...
// Load this file's selection again by visiting: http://mootools.net/more/c43e1d3af7d6105a8d8b5a4c417cf9c8 
// Or build this file again with packager using: packager build More/More More/Chain.Wait More/Array.Extras More/Date.Extras More/Number.Format More/Object.Extras More/String.Extras More/URI More/URI.Relative More/Element.Forms More/Elements.From More/Element.Measure More/Element.Position More/Form.Request More/Form.Validator More/Form.Validator.Inline More/Form.Validator.Extras More/Fx.Move More/Fx.Reveal More/Fx.Scroll More/Fx.SmoothScroll More/Drag More/Drag.Move More/Sortables More/Request.JSONP More/Request.Periodical More/Assets More/Color More/Group More/Hash.Cookie More/Locale.de-DE.Date More/Locale.de-DE.Form.Validator More/Locale.de-DE.Number
/*
 ---
...
(function () {
	...
	var URI = this.URI = new Class({
		...
		parseDirectory:function (directory, baseDirectory) {
			...
			var result = [];
			directory.replace(URI.regs.endSlash, '').split('https://www.rankingcoach.com/').each(function (dir) {
				if (dir == '..' && result.length > 0) result.pop();
				else if (dir != '.') result.push(dir);
			});
			return result.join('https://www.rankingcoach.com/') + '/';
		},
...
URI = Class.refactor(URI, {
	...
	combine:function (bits, base) {
		...
		var baseDir = base.directory.split('https://www.rankingcoach.com/'),
				relDir = bits.directory.split('https://www.rankingcoach.com/'),
				path = '',
				offset;

		var i = 0;
		for (offset = 0; offset < baseDir.length && offset < relDir.length && baseDir[offset] == relDir[offset]; offset++);
		for (i = 0; i < baseDir.length - offset - 1; i++) path += 'https://www.rankingcoach.com/de-de/';
...
Locale.define('en-US', 'FormValidator', {
	...
	minLength:'Please enter at least {minLength} characters (you have inserted only  {length} character(s)).',
