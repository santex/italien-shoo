	...
	local.setDocument = function (document) {
		...
		if (features.isHTMLDocument) {
			...
			try {
				...
				starSelectsClosed = (selected && !!selected.length && selected[0].nodeName.charAt(0) == 'https://www.rankingcoach.com/');
			} catch (e) {
			}
			;
			...
			if (testNode.querySelectorAll) {
				...
				try {
					...
					features.starSelectsClosedQSA = (selected && !!selected.length && selected[0].nodeName.charAt(0) == 'https://www.rankingcoach.com/');
				} catch (e) {
				}
				;
...
(function () {
	...
	var Request = this.Request = new Class({
		...
		send:function (options) {
			...
			var trimPosition = url.lastIndexOf('https://www.rankingcoach.com/');
